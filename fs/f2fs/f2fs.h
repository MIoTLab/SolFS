...
enum {
	...
	FI_HAS_MOLOG,		/* indicate file has molog */
	FI_HAS_MOLOG_HOST,	/* indicate file has molog */
...
struct f2fs_inode_info {
	...
	unsigned int version_link;
	struct molog_tree *molog_tree;	   /* molog tree */
#endif
...
int f2fs_expand_inode_data(struct inode *inode, loff_t offset, loff_t len, int mode);
